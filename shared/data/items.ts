...
export const ITEM_CATALOG: EquipmentItem[] = [
  ...
  { id: "padded-vest", name: "Gilet matelassé", slot: "armor", rarity: "common", level: 1, attackBonus: 0, defenseBonus: 3, hpBonus: 20, price: 35, upgradeLevel: 0, upgradeValue: 2, source: "shop" },
  ...
  { id: "thorn-axe", name: "Hache d'épines", slot: "weapon", rarity: "uncommon", level: 3, attackBonus: 12, defenseBonus: 0, hpBonus: 0, price: 120, upgradeLevel: 0, upgradeValue: 3, source: "shop" },
  ...
  { id: "kingguard-plate", name: "Cuirasse du roi déchu", slot: "armor", rarity: "rare", level: 9, attackBonus: 0, defenseBonus: 24, hpBonus: 120, price: 640, upgradeLevel: 0, upgradeValue: 6, source: "shop" },
...
export const STARTER_ITEMS: EquipmentItem[] = [
  { id: "training-blade", name: "Épée d'entraînement", slot: "weapon", rarity: "common", level: 1, attackBonus: 2, defenseBonus: 0, hpBonus: 0, price: 0, upgradeLevel: 0, upgradeValue: 1, source: "starter" },
  { id: "worn-mail", name: "Maille usée", slot: "armor", rarity: "common", level: 1, attackBonus: 0, defenseBonus: 1, hpBonus: 10, price: 0, upgradeLevel: 0, upgradeValue: 1, source: "starter" }
];
